...
CPPFLAGS +=  $(DEFINES)  
CPPFLAGS +=  -I$(WORKSPACE)/ArduinoJson/src -I $(IDF_PATH)/components/freertos/include/freertos  -I$(WORKSPACE)/limero/inc
...
STEPPER :
	touch main/main.cpp
	make DEFINE=" -DSTEPPER=1 -DHOSTNAME=drive"
